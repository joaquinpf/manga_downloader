...
class MangaPanda(SiteParserBase):
    ...
    def __init__(self):
        SiteParserBase.__init__(self, 'http://www.mangapanda.com', 'MangaPanda')
    ...
    def parse_chapters(self, url, manga):
        ...
        chapters = MangaPanda.re_get_chapters.findall(source)
    ...
    def download_chapter(self, max_pages, url, manga_chapter_prefix, current_chapter):
        for page in MangaPanda.re_get_page.findall(get_source_code(url, config.proxy)):
